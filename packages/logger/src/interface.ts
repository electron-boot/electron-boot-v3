...
export type LoggerCustomInfoHandler = (info: LoggerTransformableInfo) => LoggerTransformableInfo;
...
export interface IGenericChildLogger extends ILogger, Pick<IGenericLogger, 'write' | 'createContextLogger'> {
